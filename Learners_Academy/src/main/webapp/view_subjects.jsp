...
<body>
	...
	<div class="home-section">
		...
		<div class="table-container">
			<h1 class="heading"><%= request.getParameter("teacher_name") %> : Subject List</h1>
			<table class="table">
				...
				Teacher teacher=sess.get(Teacher.class, teacher_id);
				List<Subject>list=teacher.getSubject_list();
				for(Subject s:list) {
